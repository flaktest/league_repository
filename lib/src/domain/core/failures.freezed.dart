...
/// @nodoc
abstract class $ProfanityCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $ProfanityCopyWith(
...
/// @nodoc
class _$ProfanityCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $ProfanityCopyWith<T, $Res> {
  _$ProfanityCopyWithImpl(
      Profanity<T> _value, $Res Function(Profanity<T>) _then)
      : super(_value, (v) => _then(v as Profanity<T>));

  @override
  Profanity<T> get _value => super._value as Profanity<T>;
...
class _$Profanity<T> with DiagnosticableTreeMixin implements Profanity<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ValueFailure<$T>.profanity(failedValue: $failedValue)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ValueFailure<$T>.profanity'))
      ..add(DiagnosticsProperty('failedValue', failedValue));
  }
...
/// @nodoc
abstract class $UnderAgeCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory $UnderAgeCopyWith(
...
/// @nodoc
class _$UnderAgeCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $UnderAgeCopyWith<T, $Res> {
  _$UnderAgeCopyWithImpl(UnderAge<T> _value, $Res Function(UnderAge<T>) _then)
      : super(_value, (v) => _then(v as UnderAge<T>));

  @override
  UnderAge<T> get _value => super._value as UnderAge<T>;
...
class _$UnderAge<T> with DiagnosticableTreeMixin implements UnderAge<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ValueFailure<$T>.underAge(failedValue: $failedValue)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ValueFailure<$T>.underAge'))
      ..add(DiagnosticsProperty('failedValue', failedValue));
  }
